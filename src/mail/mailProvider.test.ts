...
import { MockMailProvider, MailRegistry } from './mailProvider';
import { renderEmailVerification, renderAlertEmail } from './templates';
...
describe('mailProvider (#367)', () => {
  ...
  it('renders templates with required HTML and plaintext parts', () => {
    const verifyMsg = renderEmailVerification('user@example.com', 'https://neurowealth.app/verify?token=123');
