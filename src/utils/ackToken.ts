...
const ACK_TOKEN_SECRET = process.env.JWT_SECRET || 'neuro-ack-token-secret-key-32b';
...
export function signAckToken(ruleId: string, fireId: string, userId: string, ttlSeconds = 86400): string {
