...
export async function issueStreamTicket(req: Request, res: Response): Promise<void> {
  ...
  const streamUserId = typeof actor === 'string' && actor.trim() ? actor.trim() : viewerUserId;
